...
(add-hook 'ensime-mode-hook
  (lambda ()
    ...
    (define-key ensime-mode-map (kbd "C-c a f i") 'ensime-type-at-point-full-name)
    (add-hook 'before-save-hook 'ensime-format-source nil t)
  )
)
(setq scala-indent-offset 2)
