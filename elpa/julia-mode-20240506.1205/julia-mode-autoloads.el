...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "julia-mode" '("julia-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "julia-mode-latexsubs" '("julia-")))
