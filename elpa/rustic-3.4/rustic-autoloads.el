...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "rustic-babel" '("rustic-" "org-babel-execute:rust" "crate-dependencies" "cargo-toml-dependencies")))
