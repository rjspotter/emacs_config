...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "smartparens-config" '("sp-lisp-in")))
...
;;;***

;;;### (autoloads nil "smartparens-javascript" "smartparens-javascript.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from smartparens-javascript.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "smartparens-javascript" '("sp-")))
...
;;;***

;;;### (autoloads nil nil ("smartparens-c.el" "smartparens-coq.el"
;;;;;;  "smartparens-erlang.el" "smartparens-go.el" "smartparens-ml.el"
