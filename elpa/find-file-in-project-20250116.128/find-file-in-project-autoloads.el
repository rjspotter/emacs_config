;;; find-file-in-project-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(fn PROMPT COLLECTION &optional ACTION)")
...
(fn KEYWORD &optional FIND-DIRECTORY-P)")
...
(fn KEYWORD OPEN-ANOTHER-WINDOW &optional FIND-DIRECTORY-P FN)")
...
See (info \"(Emacs) Directory Variables\") for details." t)
...
(fn &optional OPEN-ANOTHER-WINDOW)" t)
...
The file name is selected interactively from candidates in project." t)
...
(fn &optional FIND-DIRECTORY-P)" t)
...
Please note in \"regex\", space represents any string." t)
